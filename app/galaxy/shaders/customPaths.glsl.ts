// Active path variants: Spiral, Jets, Vortex, Crystal Weave, Chrono Streams,
// Lunar Halo Drift, Tidal Stream Bands, Pillar Glow Columns, Lagoon Mist Sheet, Ice Coma Bloom
// Removed (commented out): Aurora Bloom (2), Helix (7), Crescent Arcway (9), Star Nursery Cluster (13),
// Dust Lane Veil (14), Aurora Veil Curtain (16), Binary Glow Orbit (17)
// Controlled by uniform extraPathMode
// 0=Base,1=Spiral,(2 removed),3=Jets,4=Vortex,5=CrystalWeave,6=ChronoStreams,(7 removed),
// 8=LunarHaloDrift,(9 removed),10=TidalStreamBands,11=PillarGlowColumns,12=LagoonMistSheet,
// (13 removed),(14 removed),15=IceComaBloom,(16 removed),(17 removed)
...
export const CUSTOM_PATHS_SNIPPET = `
  ...
  // (Star Nursery Cluster (13) removed)

  // (Dust Lane Veil (14) removed)
  ...
  // (Aurora Veil Curtain (16) removed)

  // (Binary Glow Orbit (17) removed)
